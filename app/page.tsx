      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-24 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Body */}
            <p className="text-body-lg text-neutral-300 max-w-2xl mx-auto mb-12">
              {HERO_BODY}
            </p>
            ...
            <div className="flex items-center gap-2 max-w-xl mx-auto mb-16 p-1.5 bg-white rounded-2xl border border-neutral-200 shadow-md shadow-neutral-100">
              <div className="flex flex-1 items-center gap-3 px-4">
                <Search className="w-5 h-5 text-neutral-300 flex-shrink-0" />
                <input
                  type="text"
                  placeholder="사이트명 또는 주소를 입력하세요"
                  className="flex-1 bg-transparent py-3 outline-none text-body-sm text-neutral-900 placeholder:text-neutral-300"
                />
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-xs text-neutral-300 pt-2 pl-1">
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {[
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-body-sm text-neutral-300" style={{ wordBreak: 'keep-all' }}>
                    {item.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="p-6 rounded-xl bg-slate-50 border border-neutral-100 mb-6">
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-body-sm text-neutral-300">공개 신고 경로:</span>
              {[
          ...
          {/* Disclaimer */}
          <p className="text-body-sm text-neutral-300 leading-relaxed" style={{ wordBreak: 'keep-all' }}>
            {CRITERIA_DISCLAIMER}
          </p>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-white border-t border-neutral-100">
        <div className="max-w-5xl mx-auto">
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-2 text-body-sm text-neutral-300">
                  <AlertTriangle className="w-4 h-4 text-neutral-300 flex-shrink-0" />
          ...
          <div className="flex items-center justify-between p-5 rounded-xl bg-slate-50 border border-neutral-100">
            <p className="text-body-sm text-neutral-300">최신 리포트를 모두 확인하세요</p>
            ...
            {[
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-body-sm text-neutral-300" style={{ wordBreak: 'keep-all' }}>{cat.desc}</p>
                </div>
              </a>
            ))}
          </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-white border-t border-neutral-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
            {[
              { n: '1', title: '접수', desc: '사이트명, 주소, 제보 유���, ��세 내용 입력' },
              ...
              <div key={step.n} className="text-center p-5 rounded-xl bg-slate-50 border border-neutral-100">
                ...
                <p className="text-body-sm text-neutral-300" style={{ wordBreak: 'keep-all' }}>{step.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-5 rounded-xl bg-neutral-100 border border-neutral-200">
            <div className="flex items-center gap-3 text-body-sm text-neutral-300">
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="text-body-sm text-neutral-300 mb-8" style={{ wordBreak: 'keep-all' }}>
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-5 h-5 flex-shrink-0 transition-transform mt-0.5 ${
                          openFaq === i ? 'rotate-180 text-blue-500' : 'text-neutral-300'
                        }`}
                      />
                    </button>
                    {openFaq === i && (
