  ...
  return (
    <main className="min-h-screen bg-background font-sans">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-body-lg text-body max-w-2xl mx-auto" style={{ wordBreak: 'keep-all' }}>
              안전 가이드는 안심고고가 토토·카지노 niche 입문자에게 필요한 기초 개념, 종목별 룰, 피해예방 체크포인트를 단계별로 정리한 학습 경로형 카테고리입니다.
            </p>
          </div>

          <div className="space-y-4 max-w-3xl mx-auto">
            <p className="text-body text-body leading-relaxed" style={{ wordBreak: 'keep-all' }}>
              이용 권유 자료는 일절 다루지 않고 토토 가이드 디렉토리에 입문자 단계별 학습 자료만 등록해 운영합니다. 자료는 안심고고 편집부 5명이 자체 정리한 결과이며 외부 권위 출처에 의존하지 않습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-secondary border-b border-border/50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-h2 text-heading mb-6">입문자 학습 경로 (단계별)</h2>
            <p className="text-body-lg text-body max-w-2xl mx-auto" style={{ wordBreak: 'keep-all' }}>
              안심고고 가이드는 4단계 학습 경로를 운영하며, 각 단계는 분기 단위로 갱신되고 다음 단계로 자연스럽게 이어지도록 설계됩니다.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-background border-b border-border/50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-h2 text-heading mb-6">피해예방 체크리스트</h2>
            <p className="text-body-lg text-body max-w-2xl mx-auto" style={{ wordBreak: 'keep-all' }}>
              누적 제보 데이터에서 가장 많이 반복된 피해 패턴을 기반으로 작성된 체크리스트입니다.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-secondary border-b border-border/50">
        <div className="max-w-5xl mx-auto">
          <div className="p-8 rounded-xl bg-accent border border-border/50">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                <Lightbulb className="w-5 h-5 text-primary" />
              </div>
              <div>
                <h3 className="text-h2 text-heading mb-6">가이드 활용 범위 안내</h3>
