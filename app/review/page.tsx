    ...
    <main className="min-h-screen bg-background font-sans">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {[
              ...
              <div key={step.n} className="text-center p-6 rounded-xl bg-background border-2 border-transparent hover:border-primary/50 hover:shadow-md transition-all">
                <div className="w-11 h-11 rounded-full bg-primary text-white flex items-center justify-center mx-auto mb-4 text-body-sm font-bold shadow-sm">
                  {step.n}
                </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-20 bg-background border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10 p-7 rounded-xl bg-accent border-2 border-border/50 shadow-sm">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 mb-10">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-5 rounded-lg bg-background border-2 border-transparent hover:border-primary/50 hover:shadow-md transition-all">
                <signal.icon className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  <p className="text-body font-semibold text-heading mb-1">{signal.label}</p>
